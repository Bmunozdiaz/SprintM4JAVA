...
/*
 * Clase llamada Accidente que permite obtener los registros sobre un accidente. 
 */
public class Accidente {
	...
	// Constructor vacio de la clase Accidente que no recibe parametros.
	public Accidente() {
		super();
 ...
 *  Sobrescribe el metodo ToString para presentar por consola los datos asociados al accidente registrado.
*/
	@Override
