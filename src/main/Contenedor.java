...
public class Contenedor {
	...
	// Creacion de arreglos y listas para las diferentes clases del proyecto.
	...
	// Metodo que permite almacenar un nuevo usuario a la lista de tipo de Usuarios.
	public void addUsuario (Usuario usuario) {
		listaUsuarios.add(usuario);
	}
	
	// Este metodo recorre la lista de tipo Usuario.
	...
	// Metodo que despliega un menu que permite registrar diferentes tipos de Usuarios y capacitaciones junto a su listado.
	public void menu() {
		System.out.println("\nMenú");
...
/*
*  Metodo que permite almacenar un nuevo Usuario del tipo Cliente a la lista de tipo Cliente.
*  Solicita al Usuario el ingreso de todos los datos asociados al Usuario Cliente junto a una validacion de campos ya sea de caracter obligatorio,longitud y formato.
*/
	private void almacenarCliente() {
		...
		System.out.println("Usuario tipo Cliente almacenado!");
		menu();
	} // Cierra el metodo almacenarCliente.
	
/*
*  Metodo que permite almacenar un nuevo Usuario del tipo Profesional a la lista de tipo Profesional.
*  Solicita al Usuario el ingreso de todos los datos asociados al Usuario Profesional junto a una validacion de campos ya sea de caracter obligatorio,longitud y formato.
*/
	private void almacenarProfesional() {
		...
		System.out.println("Usuario tipo Profesional almacenado!");
		menu();
			
	} // Cierra el metodo almacenarProfesional.
	
/*
*  Metodo que permite almacenar un nuevo Usuario del tipo Administrativo a la lista de tipo Administrativo.
*  Solicita al Usuario el ingreso de todos los datos asociados al Usuario Administrativo junto a una validacion de campos ya sea de caracter obligatorio,longitud y formato.
*/
	private void almacenarAdministrativo() {
		...
		// Creacion de un objeto de tipo Administrativo que almacena los datos ingresados mediante consola por el Usuario.
		...
		System.out.println("Usuario tipo Administrativo almacenado!");
		menu();
		
	} // Cierra el metodo almacenarAdministrativo.
	
/*
 *  Metodo que permite almacenar una nueva capacitacion a la lista de tipo Capacitacion.
 *  Solicita al Usuario el ingreso de todos los datos asociados a la Capacitacion junto a una validacion de campos ya sea de caracter obligatorio,longitud y formato.
 */
	private void almacenarCapacitacion() {
		...
		// Creacion de un objeto de tipo Capacitacion que almacena los datos ingresados mediante consola por el Usuario.
	...
	// Metodo que permite listar los datos de las capacitaciones anteriormente registradas con el metodo almacenarCapacitacion.
	private void listarCapacitaciones() {
		if (listaCapacitaciones.isEmpty()) {
			...
			for (int i = 0; i < listaCapacitaciones.size(); i++) {
				...
				System.out.println("Hora: " + cap.getHora());
	...
	// Metodo que permite terminar la ejecucion mediante consola del programa.
	private void salir() {
		System.out.println("\nSaliendo..");
		System.exit(0);
	} // Cierra el metodo salir
	
	// Metodo que muestra un mensaje de error en caso de que el usuario digite una opcion invalida.
