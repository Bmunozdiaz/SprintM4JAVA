...
public class Capacitacion {
	...
	// Constructor vacio de la clase Capacitacion que no recibe parametros.
	public Capacitacion() {
	} // Cierra el constructor vacio de la clase Capacitacion;

	// Constructor que posee los parametros de la clase Capacitacion.
	...
	// Metodo que permite desplegar por consola los detalles asociados a una capacitacion.
...
* Sobrescribe el metodo ToString para presentar por consola los datos asociados a la capacitacion registrada.
*/
	@Override
